...
#?start=1104 ?start=1884

wechat_pages <- c("https://chuansongme.com/account/bullpiano",
                  paste0("https://chuansongme.com/account/bullpiano?start=", seq(from = 1104, to = 1884, by = 12)))
...
wechat_data <- wechat_data[14:805,]
...
#another program.
wechat_data <- read.csv("C:/Users/irene/Documents/GitHub/chinese_media/bullpiano_may18_sept18.csv", stringsAsFactors = F)
write.csv(wechat_data, "C:/Users/irene/Documents/GitHub/chinese_media/bullpiano_may18_sept18.csv", fileEncoding = "UTF-8", row.names = F)
